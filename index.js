...
class Instructor extends Lambdasian {
    ...
    adjustGrade(student) {
        let tog = Math.round(Math.random());
        if (tog) {
    ...
    helpStudGrad(student) {
        if (student.grade > 70) {
            return `Congrats, ${student.name}, you've graduated!`
        } else {
            this.adjustGrade(student);
        }
    }
}
...
class Student extends Lambdasian {
    ...
    graduate() {
        if (this.grade > 70) {
            ...
            return `${this.name} needs to study!`
        }
    }
}
